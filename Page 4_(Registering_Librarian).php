...
<html>
    ...
    <body>
        ...
        echo "<p style=\" font-size: 25px; margin-left: 3%; color: #001641\">Librarian Details...</p>";
        ...
        ?>
            <div class="form_section">
                <form action="Page 4_(Registering_Librarian).php" method="post">

             <input type="text" placeholder="Name" name="lib_name">
                        <div class="error">
                    ...
                    <input type="text" placeholder="Phone" name="lib_phone">
                        <div class="error">
                            <?php echo $GLOBALS["Global_error_message_phone"]; ?> 
                        </div>
                        
                    <input type="text" placeholder="Email" name="lib_email">
                        <div class="error">
        ...
        function work_section() {
            ...
            if (empty($_POST['lib_name'])) {
                $errorCount += 1;
                $GLOBALS["Global_error_message_name"] = "<p>Librarian Name is empty.</p>";
            }
            ...
            if ($errorCount == 0) {
                ...
                $lib_id = $lib_name[0] . $lib_name[1] . strval($ThreeDigitRandomNumber);

                insert_into_librarian_table("Librarian", $lib_id, $lib_name, $surname, $lib_phone, $lib_email);
                insert_into_login_table("Login", $lib_id, $password);
                echo "<script type='text/javascript'>alert('Librarian ID = {$lib_id}');</script>";
